...
public class ShoppingCartPageTest {
    ...
    public void iVerifyTheTextBuildYourOwnComputer() {
      /*  String expMessage = "Build your own computer";
        Assert.assertEquals("Not on Build your own page", expMessage, By.xpath("//h1[contains(text(),'Build your own computer')]"));*/
    }

    @And("^I Select (\\d+)\\.(\\d+) GHz Intel Pentium Dual-Core E(\\d+) using Select$")
    public void iSelectGHzIntelPentiumDualCoreEUsingSelect() {
        new ShoppingCartPage().selectByDropDown("Selecting 2.2 GHz Intel Pentium Dual-Core E2200", By.name("product_attribute_1"), "2.2 GHz Intel Pentium Dual-Core E2200");
    }
